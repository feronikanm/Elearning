...
import com.fero.elearning.databinding.ItemsAcademyBinding
import com.fero.elearning.ui.detail.DetailCourseActivity
...
class AcademyAdapter : RecyclerView.Adapter<AcademyAdapter.CourseViewHolder>() {
    ...
    inner class CourseViewHolder(val binding: ItemsAcademyBinding) : RecyclerView.ViewHolder(binding.root) {
